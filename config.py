...
#     DEBUG = True
#     HOST = '0.0.0.0',  # Running on localhost
#     SQLALCHEMY_DATABASE_URI = DB_URL
#     SQLALCHEMY_TRACK_MODIFICATIONS=False,

#     # SECRET_KEY = "BilboBolson",
#     # JWT_SECRET_KEY = "Myprecious"
...
#     # SQLALCHEMY_DATABASE_URI = os.environ.get("SQLALCHEMY_DATABASE_URI").replace("://", "ql://", 1)
